...
namespace
{
    ...
    void ReadDependency( xml::xistream& xis, const T_Components& components, std::ostream& os, const std::string& from )
    {
        ...
        T_Component::const_iterator(T_Component::*endComponent)() const = &T_Component::end;
        ...
        boost::function< T_Component::const_iterator( const T_Component& ) > end = boost::bind< T_Component::const_iterator >( endComponent, _1 );
